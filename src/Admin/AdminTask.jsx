        ...
        selectedTasks.forEach((task) => {
          ...
          promises.push(
            axios
              ...
              .catch((error) => {
                toast.error(
                  `Failed to assign ${task.title} to ${
                    users.find((u) => u._id === userId)?.name || "user"
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 p-6">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-6 bg-white/60 dark:bg-gray-900/60 backdrop-blur border-b">
              ...
              <div className="text-center">
                ...
                <p className="text-2xl font-bold text-blue-600">
                  {activeTab === "technical"
                    ? technicalTask.assignedTo
                      ? 1
                      : 0
                    : socialTask.assignedTo.length}
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm font-medium">
                  {activeTab === "technical"
                    ? technicalTask.endDate || "Not set"
                    : socialTask.endDate || "Not set"}
                </p>
              </div>
            </div>
                  ...
                  {activeTab === "technical" ? (
                      ...
                      <div className="m-3">
                        <div className="border rounded-xl p-4 bg-gray-50 dark:bg-gray-800">
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">
                            ...
                            {activeTab === "technical"
                              ? technicalTask.startDate && technicalTask.endDate
                                ? `${technicalTask.startDate} → ${technicalTask.endDate}`
                                : "—"
                              : socialTask.startDate && socialTask.endDate
                              ? `${socialTask.startDate} → ${socialTask.endDate}`
                              : "—"}
                          </p>
                        </div>
                    ...
                    <form onSubmit={handleSocialSubmit} className="space-y-6">
                      ...
                      <div data-aos="fade-up" className="mt-3">
                        {socialTask.assignedTo.length > 0 && (
                          <>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">
                              Selected:
                            </label>
                            <div className="mt-4 flex flex-wrap gap-2">
                              {socialTask.assignedTo.map((id) => {
                                const user = users.find((u) => u._id === id);
                                return (
                                  <span
                                    key={id}
                                    className="px-3 py-1 bg-blue-100 dark:bg-blue-800/30 text-blue-700 dark:text-blue-200 rounded-full text-xs"
                                  >
                                    {user?.name}
                                  </span>
                                );
                      ...
                      <div className="m-3">
                        ...
                        {socialTask.tasks.every((t) => !t.selected) && (
                          <p className="text-sm text-red-500">
                            ⚠ No social tasks selected
                          </p>
                        )}
                      </div>
