      ...
      <div className="w-full max-w-[1440px] mx-auto my-6 px-4 md:px-10 bg-transparent">
        ...
        <div className="mb-8">
          <div className="flex justify-center">
            <div className="inline-flex bg-gray-100 dark:bg-slate-800 p-1 rounded-xl shadow-inner dark:shadow-none border border-gray-200 dark:border-slate-700">
...
const TaskCard = ({
  ...
  return (
    ...
    >
      <Card
        className={`border ${statusStyles.border} rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 h-full flex flex-col ${statusStyles.hoverBg} dark:bg-slate-900`}
      >
        {/* Card Header */}
        <div
          ...
          <div className="flex justify-between items-start gap-3">
            ...
            <div className="flex flex-col items-end gap-2">
              ...
              {submission.selfEvaluation && (
                <span
                  className={`px-2 py-1 text-[11px] font-medium rounded-full border ${selfEvalClass}`}
                >
                  Self Eval:{" "}
        ...
        <CardContent className="p-4 flex-1 flex flex-col bg-white/60 dark:bg-slate-900/80">
                ...
                {submission.image ? (
                  ...
                  >
                    <img
                      ...
                      alt="Task Submission"
                      className="rounded-lg w-full h-32 object-cover border border-gray-200 dark:border-slate-700 shadow-sm transition-all duration-300 hover:shadow-md"
                    />
                  </motion.div>
                ) : (
                  <span className="text-gray-500 dark:text-slate-400 text-sm">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            {effectiveReviewStatus === "Pending" ? (
              ...
              <motion.div
                className="w-full text-center py-2 px-4 rounded-lg text-sm font-medium bg-gray-50 dark:bg-slate-800"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              >
