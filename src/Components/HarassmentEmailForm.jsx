      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 dark:bg-slate-900 p-4">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-b-lg shadow-lg p-4 sm:p-6 md:p-8 transition-all border border-transparent dark:border-slate-700">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="transition-all">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 sm:py-3 bg-gray-50 dark:bg-slate-700 border border-gray-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-[#4263EB] focus:border-transparent text-gray-900 dark:text-gray-100 transition-all hover:border-[#4263EB] dark:hover:border-[#86a9ff]"
                  />
                </div>
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-center gap-2 py-2 sm:py-3 px-4 rounded-lg font-medium transition-all duration-200 ${
                    submitSuccess
