      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-4">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="bg-white rounded-noneb-lg shadow-lg p-4 sm:p-6 md:p-8 transition-all">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="transition-all">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2 sm:py-3 bg-gray-50 border border-gray-300 rounded-nonelg 
                ...
                <div className="transition-all">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 sm:py-3 bg-gray-50 border border-gray-300 rounded-nonelg 
                      focus:ring-2 focus:ring-[#4263EB] focus:border-transparent text-gray-900 
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-center gap-2 py-2 sm:py-3 px-4 rounded-nonelg 
