      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-4">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="bg-[#4263EB] rounded-t-lg shadow-lg p-4 sm:p-6 md:p-8">
            ...
            <div className="bg-white rounded-b-lg shadow-lg p-4 sm:p-6 md:p-8 transition-all">
              <div className="flex items-center gap-3 mb-4 sm:mb-6">
                <AlertCircle className="w-5 h-5 sm:w-6 sm:h-6 text-[#4263EB]" />
                <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-800">Write Complaint</h2>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="transition-all">
                  ...
                  <div className="relative group">
                    <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400 
                      transition-colors group-hover:text-[#4263EB]" />
                    <input
                      type="email"
                      id="email"
                      value={email}
                      ...
                      className="w-full pl-10 pr-4 py-2 sm:py-3 bg-gray-50 border border-gray-300 rounded-lg 
                        focus:ring-2 focus:ring-[#4263EB] focus:border-transparent text-gray-900 
                        placeholder-gray-500 transition-all hover:border-[#4263EB]"
                    />
                  </div>
                </div>
                ...
                <div className="transition-all">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 sm:py-3 bg-gray-50 border border-gray-300 rounded-lg 
                      focus:ring-2 focus:ring-[#4263EB] focus:border-transparent text-gray-900 
                      transition-all hover:border-[#4263EB]"
                  />
                </div>
                ...
                <div className="transition-all">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-2 sm:py-3 bg-gray-50 border border-gray-300 rounded-lg 
                      focus:ring-2 focus:ring-[#4263EB] focus:border-transparent text-gray-900 
                      placeholder-gray-500 resize-none transition-all hover:border-[#4263EB]"
                  />
                </div>
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-center gap-2 py-2 sm:py-3 px-4 rounded-lg 
                    font-medium transition-all duration-200 ${
                      submitSuccess
                        ? "bg-green-500 hover:bg-green-600"
                        : "bg-[#4263EB] hover:bg-[#3B82F6]"
