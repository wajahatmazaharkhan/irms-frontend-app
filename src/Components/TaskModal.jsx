      ...
      <Dialog open={true} onClose={() => {}} className="relative z-50">
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            <DialogPanel className="relative w-full max-w-lg rounded-lg bg-white dark:bg-slate-900 p-8 text-center shadow-xl dark:shadow-2xl dark:border dark:border-slate-700">
    ...
    >
      ...
      <div className="fixed inset-0 z-50 overflow-y-auto">
        <div className="flex min-h-screen items-start justify-center pt-10 px-4 sm:pt-16 sm:px-6">
          <DialogPanel className="w-full max-w-3xl md:max-w-4xl rounded-xl bg-white dark:bg-slate-900 shadow-2xl dark:shadow-2xl dark:border dark:border-slate-700">
            <div className="max-h-[85vh] overflow-y-auto">
                  ...
                  <div className="lg:col-span-2 space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="mt-2 block w-full rounded- border border-gray-300 dark:border-slate-700 px-4 py-3 text-sm placeholder:text-gray-400 dark:placeholder:text-slate-500 focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:text-slate-100"
                        rows={4}
                      />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <textarea
                          ...
                          className="mt-2 block w-full rounded- border border-gray-300 dark:border-slate-700 px-3 py-2 text-sm placeholder:text-gray-400 dark:placeholder:text-slate-500 focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:text-slate-100"
                          rows={3}
                        />
                      </div>
                      <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="mt-2 block w-full rounded- border border-gray-300 dark:border-slate-700 px-3 py-2 text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:text-slate-100"
                      >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div
                      ...
                      className={`mt-2 flex flex-col justify-center rounded-lg border-2 border-dashed p-5 ${
                        dragActive
                    ...
                    >
                      <div className="flex flex-col items-center text-center space-y-2">
                        ...
                        <div className="flex flex-col text-sm leading-6 text-gray-600 dark:text-slate-300">
                          <label className="relative cursor-pointer rounded-md bg-white dark:bg-slate-800 font-semibold text-blue-600 dark:text-blue-400 focus-within:outline-none focus-within:ring-2 focus-within:ring-blue-600 focus-within:ring-offset-2 hover:text-blue-500 dark:hover:text-blue-300 px-3 py-2">
                        ...
                        <p className="text-xs leading-5 text-gray-600 dark:text-slate-400">
                          Ideal for reports, literature reviews, or detailed
                          write-ups.
                        </p>
                        {file && (
                  ...
                  <div>
                    ...
                    <div
                      ...
                      className={`mt-2 flex justify-center rounded-lg border-2 border-dashed p-5 ${
                        dragActive
                          ? "border-blue-500 bg-blue-50 dark:border-blue-400 dark:bg-slate-900/60"
                          : "border-gray-300 dark:border-slate-600 dark:bg-slate-900"
                      }`}
                    >
                      <div className="text-center">
                        ...
                        <div className="mt-3 flex flex-col text-sm leading-6 text-gray-600 dark:text-slate-300 items-center">
                          ...
                          <p className="pl-1 text-xs mt-1">or drag and drop</p>
                        </div>
                        <p className="text-xs leading-5 text-gray-600 dark:text-slate-400">
              ...
              {/* Footer */}
              <div className="sticky bottom-0 bg-gray-50 dark:bg-slate-900/95 px-6 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 rounded-b-lg border-t border-gray-200 dark:border-slate-700">
                ...
                <div className="flex justify-end space-x-3">
                  <button
                    ...
                    className="rounded-md px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-300 dark:text-slate-200 dark:hover:bg-slate-800 dark:focus:ring-slate-600"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    className="rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed dark:bg-blue-600 dark:hover:bg-blue-500 dark:focus:ring-blue-500 dark:focus:ring-offset-slate-900"
                  >
                    Submit Task
                  </button>
                </div>
