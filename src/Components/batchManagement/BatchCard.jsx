...
export const BatchCard = ({batch, handleView, handleEditClick, handleDeleteBatch, deleteLoading}) => {
    ...
    >
        ...
        <div className="flex gap-2">
            <button className="flex-1 bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 transition-colors duration-200 text-sm font-medium" onClick={() => handleView(batch.id)}>
                View Details
            </button>
