    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="container mx-auto p-6">
          ...
          {/* Filters and Search */}
          <div className="bg-white rounded-nonexl shadow-md p-6 mb-8">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="relative w-full md:w-1/3">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 border rounded-nonelg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              <div className="relative w-full md:w-auto">
                ...
                <select
                  ...
                  className="pl-10 pr-4 py-2 border rounded-nonelg focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
