      ...
      <div className="h-screen flex flex-col bg-gray-50 dark:bg-gray-900 overflow-hidden">
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center max-w-md mx-auto p-8">
            <div className="w-20 h-20 bg-blue-100 dark:bg-blue-900/40 rounded- flex items-center justify-center mx-auto mb-4">
              <svg
            ...
            <div className="bg-white dark:bg-gray-900/70 p-4 border border-gray-200 dark:border-gray-700 shadow-sm rounded-">
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
      ...
      <div className="shrink-0">
        ...
        {/* Error */}
        {error && (
          <div className="mx-4 mt-4 mb-2 px-4 py-3 bg-red-100 dark:bg-red-900/40 border border-red-300 dark:border-red-700 rounded- text-red-700 dark:text-red-300">
        ...
        <div className="shrink-0 border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-3">
          <div className="flex items-center gap-3 max-w-4xl mx-auto">
            <input
              ...
              className="flex-1 px-4 py-2 sm:py-3 rounded- border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-400 focus:border-transparent dark:focus:ring-blue-500 dark:bg-gray-800 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
            />
            <button
              onClick={handleSend}
              disabled={isSending || !content.trim() || !isConnected}
              className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-2 sm:p-3 rounded- hover:scale-105 transition-transform disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0"
            >
              {isSending ? (
