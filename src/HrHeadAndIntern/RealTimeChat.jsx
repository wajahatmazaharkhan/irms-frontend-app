...
export default function RealtimeChat({ ReceiverId }) {
    ...
    useEffect(() => {
        const fetchReceiverData = async () => {
            try {
                ...
                console.log("Fetched receiver data:", response.data);
            ...
            <div className="flex-1 flex flex-col bg-gray-50">
                ...
                <div className="flex-1 flex items-center justify-center">
                    <div className="text-center max-w-md mx-auto p-8">
                        ...
                        <h2 className="text-2xl font-semibold text-gray-900 mb-2">Welcome to HR Chat</h2>
    ...
    return (
        <div className="min-h-screen max-h-screen flex flex-col bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:to-gray-800">
            {/* Header */}
            <div className="flex items-center gap-3 p-4 border-b border-gray-200 bg-white">
                ...
                <div className="flex-1">
                    <h2 className="font-semibold text-gray-900">Sudhanshu</h2>
                ...
                {isLoading ? (
                    ...
                    <>
                        {messages.map((msg, index) => (
                            <div
                                key={msg._id || index}
                                className={`flex items-end gap-2 ${msg.sender === senderId ? "justify-end" : "justify-start"}`}
                            >
                                {msg.sender !== senderId && (
                                    <img
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-between mt-1 gap-2">
                                        <p className="text-[10px] opacity-60 flex-shrink-0">{formatTime(msg.createdAt || msg.timestamp)}</p>
